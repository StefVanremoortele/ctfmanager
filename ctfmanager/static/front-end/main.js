...
var HackathonComponent = /** @class */ (function () {
    function HackathonComponent(_apiService, dialog, snackBar, iconRegistry, sanitizer) {
        this._apiService = _apiService;
        this.dialog = dialog;
        this.snackBar = snackBar;
        this.hackathon_list = [];
        iconRegistry.addSvgIcon('thumbs-up', sanitizer.bypassSecurityTrustResourceUrl('./static/src/assets/img/svg/thumbup-icon.svg'));
    }
    ...
    HackathonComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services__WEBPACK_IMPORTED_MODULE_1__["ApiService"], _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"], _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"], _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatIconRegistry"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_6__["DomSanitizer"]])
    ], HackathonComponent);
